...
def calcBondPrice ():  
    ...
    label6 = tk.Label(root, text= bondPrice,font=('helvetica', 10, 'bold'),bg='black')
    canvas1.create_window(240, 380, window=label6)

    
button1 = tk.Button(text='Calculate Bond Price', command=calcBondPrice, bg='white', fg='black', font=('helvetica', 9, 'bold'))
